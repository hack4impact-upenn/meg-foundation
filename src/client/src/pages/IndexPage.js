  ...
  let testArray = [
    {
      ...
      descriptionLong: `Why it works: Knowing our voice can be heard gives us power and control. Feeling like we can have some control over what happens decreases anxiety. 
